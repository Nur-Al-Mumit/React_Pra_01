import {
  lib
} from "./chunk-GDCGBEZD.js";
import {
  postcss_default
} from "./chunk-AJVIUTDC.js";
import {
  commonjsGlobal,
  require_crypto,
  require_util
} from "./chunk-SYOV774T.js";
import "./chunk-T6P5EV2X.js";
import "./chunk-VLAJUKTR.js";
import {
  require_node_module,
  require_node_path,
  require_node_url
} from "./chunk-EPSHAH5I.js";
import "./chunk-S6H55J66.js";
import {
  require_fs,
  require_path
} from "./chunk-ZVIGBY4Y.js";
import "./chunk-5Q44J42Q.js";
import {
  __toESM
} from "./chunk-S5KM4IGW.js";

// node_modules/vite/dist/node/chunks/dep-55b95cd5.js
...
var _icssReplaceSymbols = _interopRequireDefault$6(lib2);
...
var _postcss$1 = _interopRequireDefault$5(postcss_default);
var _fs$1 = _interopRequireDefault$5(import_fs.default);
var _path = _interopRequireDefault$5(import_path.default);
...
var Core = class {
  ...
  load(sourceString, sourcePath, trace, pathFetcher) {
    let parser2 = new _parser$1.default(pathFetcher, trace);
    return (0, _postcss$1.default)(this.plugins.concat([parser2.plugin()])).process(sourceString, {
      from: sourcePath
    }).then((result) => {
      return {
...
var FileSystemLoader = class {
  ...
  fetch(_newPath, relativeTo, _trace) {
    ...
    return new Promise((resolve, reject) => {
      let relativeDir = _path.default.dirname(relativeTo), rootRelativePath = _path.default.resolve(relativeDir, newPath), fileRelativePath = _path.default.resolve(_path.default.resolve(this.root, relativeDir), newPath);
...
(function(module, exports) {
  exports.__esModule = true;
  exports["default"] = void 0;
  var _parser2 = _interopRequireDefault2(parser.exports);
  function _interopRequireDefault2(obj) {
    return obj && obj.__esModule ? obj : { "default": obj };
  }
  var Processor = function() {
    ...
    _proto._root = function _root2(rule, options) {
      ...
      var parser2 = new _parser2["default"](rule, this._parseOptions(options));
      return parser2.root;
    };
...
function getLoader(opts, plugins) {
  ...
  return typeof opts.Loader === "function" ? new opts.Loader(root3, plugins) : new _loader.default(root3, plugins);
}
  ...
  return {
    ...
    async OnceExit(css, {
      ...
      if (opts.localsConvention) {
        ...
        parser2.exportTokens = Object.entries(parser2.exportTokens).reduce((tokens, [className3, value]) => {
          if (isFunc) {
...
//# sourceMappingURL=dep-55b95cd5-NNO3345T.js.map

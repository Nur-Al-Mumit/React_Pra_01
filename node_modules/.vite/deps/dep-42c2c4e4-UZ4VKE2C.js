...
// node_modules/vite/dist/node/chunks/dep-42c2c4e4.js
  ...
  ${charset.node.params} specified in ${charset.node.source.input.file}`
      ...
      function loadImportContent(result2, stmt, filename, options2, state2) {
        ...
        layer.forEach((layerPart, i) => {
          if (layerPart === "") {
            if (options2.nameLayer) {
              layer[i] = options2.nameLayer(state2.anonymousLayerCounter++, state2.rootFilename).toString();
            } else {
              throw atRule2.error(
...
//# sourceMappingURL=dep-42c2c4e4-UZ4VKE2C.js.map
